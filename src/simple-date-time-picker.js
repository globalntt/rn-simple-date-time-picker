...
import {
  ...
  DatePickerAndroid, TimePickerAndroid, Platform, Dimensions, StyleSheet,
} from 'react-native';
import PropTypes from 'prop-types';
import moment from 'moment';
import { getStatusBarHeight } from 'react-native-status-bar-height';
import TextField from '@globalntt/rn-text-field';
import ButtonText from '@globalntt/rn-text-button';
